...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230513200717.png)
...
![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230513200651.png)

Flutter 和 RN 的最大区别在于将“JavascriptCore/V8+JS”替换成“C++ 实现的 engine+Dart 实现的 Framework+静态类型 Dart+编译成机器码”。

![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230513200059.png)

小程序本质上和 Weex、React Native 的设计思路基本一样，最大区别在于前者还是用浏览器 WebView 做渲染引擎，而后者是单独实现了渲染引擎（所以大量的 CSS 布局模型不支持）。

![](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230512210222.png)
