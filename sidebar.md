  ...
  - [2 工程化架构](/工程化架构/README.md)
    - 2.1 CSS 模块化
      - [2.1.1 CSS in JS](/工程化架构/CSS%20模块化/CSS-in-JS/README.md)
        
      - [2.1.2 原子 CSS](/工程化架构/CSS%20模块化/原子%20CSS/README.md)
        - [2.1.2.1 TailwindCSS](/工程化架构/CSS%20模块化/原子%20CSS/TailwindCSS.md)
      - [2.1.3 约定命名](/工程化架构/CSS%20模块化/约定命名/README.md)
        - [2.1.3.1 BEM](/工程化架构/CSS%20模块化/约定命名/BEM.md)
        - [2.1.3.2 OOCSS](/工程化架构/CSS%20模块化/约定命名/OOCSS.md)
    - [2.2 主题与国际化](/工程化架构/主题与国际化/README.md)
      - [2.2.1 FormatJS](/工程化架构/主题与国际化/FormatJS.md)
      - [2.2.2 Internationalization API](/工程化架构/主题与国际化/Internationalization%20API.md)
      - [2.2.3 动态主题](/工程化架构/主题与国际化/动态主题.md)
    - 2.3 前端框架
      - [2.3.1 Svelte](/工程化架构/前端框架/Svelte/README.md)
        - [2.3.1.1 事件处理](/工程化架构/前端框架/Svelte/事件处理.md)
        - [2.3.1.2 响应式绑定](/工程化架构/前端框架/Svelte/响应式绑定.md)
        - [2.3.1.3 状态管理](/工程化架构/前端框架/Svelte/状态管理.md)
        - [2.3.1.4 组件基础](/工程化架构/前端框架/Svelte/组件基础.md)
        - [2.3.1.5 组件样式](/工程化架构/前端框架/Svelte/组件样式.md)
        - [2.3.1.6 语法编译](/工程化架构/前端框架/Svelte/语法编译.md)
      - 2.3.2 框架设计
        - [2.3.2.1 SPA](/工程化架构/前端框架/框架设计/SPA/README.md)
          
        - [2.3.2.2 框架对比](/工程化架构/前端框架/框架设计/框架对比.md)
        - [2.3.2.3 框架范式](/工程化架构/前端框架/框架设计/框架范式.md)
    - [2.4 微前端](/工程化架构/微前端/README.md)
      - [2.4.1 Module Federation](/工程化架构/微前端/Module%20Federation/README.md)
        
      - [2.4.2 代码共享方式](/工程化架构/微前端/代码共享方式.md)
      - [2.4.3 加载与切换](/工程化架构/微前端/加载与切换/README.md)
        
      - 2.4.4 实践案例
        - [2.4.4.1 EMP](/工程化架构/微前端/实践案例/EMP.md)
        - [2.4.4.2 qiankun](/工程化架构/微前端/实践案例/qiankun/README.md)
          - [2.4.4.2.1 single spa](/工程化架构/微前端/实践案例/qiankun/single-spa.md)
          - [2.4.4.2.2 快速开始](/工程化架构/微前端/实践案例/qiankun/快速开始.md)
          - [2.4.4.2.3 架构机制](/工程化架构/微前端/实践案例/qiankun/架构机制.md)
      - [2.4.5 隔离与通信](/工程化架构/微前端/隔离与通信/README.md)
        - [2.4.5.1 Web Components](/工程化架构/微前端/隔离与通信/Web%20Components.md)
        - [2.4.5.2 iframe](/工程化架构/微前端/隔离与通信/iframe.md)
        - [2.4.5.3 应用沙箱](/工程化架构/微前端/隔离与通信/应用沙箱/README.md)
          
        - [2.4.5.4 应用软隔离](/工程化架构/微前端/隔离与通信/应用软隔离.md)
    - [2.5 构建工具](/工程化架构/构建工具/README.md)
      - [2.5.1 Gulp](/工程化架构/构建工具/Gulp/README.md)
        
      - [2.5.2 Parcel](/工程化架构/构建工具/Parcel/README.md)
        
      - [2.5.3 Snowpack](/工程化架构/构建工具/Snowpack/README.md)
        
      - [2.5.4 Vite](/工程化架构/构建工具/Vite/README.md)
        - [2.5.4.1 基础配置](/工程化架构/构建工具/Vite/基础配置.md)
        - [2.5.4.2 插件开发](/工程化架构/构建工具/Vite/插件开发.md)
      - [2.5.5 Webpack](/工程化架构/构建工具/Webpack/README.md)
        - [2.5.5.1 TreeShaking](/工程化架构/构建工具/Webpack/TreeShaking.md)
        - [2.5.5.2 内部机制](/工程化架构/构建工具/Webpack/内部机制.md)
        - [2.5.5.3 基础配置](/工程化架构/构建工具/Webpack/基础配置.md)
        - [2.5.5.4 开发环境](/工程化架构/构建工具/Webpack/开发环境.md)
        - [2.5.5.5 打包部署](/工程化架构/构建工具/Webpack/打包部署.md)
    - [2.6 状态管理](/工程化架构/状态管理/README.md)
      - [2.6.1 MVVM](/工程化架构/状态管理/MVVM/README.md)
        - [2.6.1.1 VirtualDOM](/工程化架构/状态管理/MVVM/VirtualDOM.md)
        - [2.6.1.2 现代框架的 MVVM 实现](/工程化架构/状态管理/MVVM/现代框架的%20MVVM%20实现.md)
        - [2.6.1.3 高性能 DOM 变化监听与响应](/工程化架构/状态管理/MVVM/高性能%20DOM%20变化监听与响应.md)
      - [2.6.2 MobX](/工程化架构/状态管理/MobX/README.md)
        - [2.6.2.1 响应式监听](/工程化架构/状态管理/MobX/响应式监听.md)
        - [2.6.2.2 底层原理与透明响应](/工程化架构/状态管理/MobX/底层原理与透明响应.md)
      - [2.6.3 Redux](/工程化架构/状态管理/Redux/README.md)
        - 2.6.3.1 中间件与异步
  ...
  - [5 开发基础](/开发基础/README.md)
    ...
    - [5.2 DOM](/开发基础/DOM/README.md)
      ...
      - 5.2.3 选择与操作
        ...
        - [5.2.3.2 元素选择](/开发基础/DOM/选择与操作/元素选择.md)
